...
// ประกาศคำถามโดยให้เริ่มที่ -1 เพื่อให้หน้าเริ่มเกมเงื่อนไข background เริ่มที่คำถามที่ -1 เมื่อกดเริ่มจึงเริ่มคำถามที่ 0
let questions = [
...
function setup() {
  ...
  // สร้างปุ่ม the best โดยเมื่อกดจะมี sprite รูปต่าง ๆ drop ลงมาต่างกันในแต่ละข้อแล้วแต่คำถาม
  ...
  // สร้างปุ่ม nothing special โดยเมื่อกดจะมี sprite รูปต่าง ๆ drop ลงมาต่างกันในแต่ละข้อแล้วแต่คำถาม
  ...
  // สร้างปุ่ม the worst โดยเมื่อกดจะมี sprite รูปต่าง ๆ drop ลงมาต่างกันในแต่ละข้อแล้วแต่คำถาม
